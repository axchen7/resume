...
\begin{cventries}
  ...
  {Oct. 2019 - Mar. 2020} % Empty date
  {
    \begin{cvitems} % Description(s) bullet points
      ...
      \item {Utilized by robotics team to rapidly create and test different robot paths for best efficiency; incorporated knowledge of 2D kinematics to display robot's forcasted velocity and acceleration.}
